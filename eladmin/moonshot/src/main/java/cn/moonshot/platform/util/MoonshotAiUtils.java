...
public class MoonshotAiUtils {
    ...
    private static final String API_KEY = "sk-12TG9gSMR7IJznYlG9SWqBqZoVm5V5PQij81lpI5oCTReIrP";
    ...
    @SneakyThrows
    public static void chatAnalysis(@NonNull String model, @NonNull List<Message> messages) {
        String requestBody = new JSONObject()
                .putOpt("model", model)
                .putOpt("messages", messages)
                .putOpt("stream", true)
